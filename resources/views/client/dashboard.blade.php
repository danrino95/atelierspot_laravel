  ...
  <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="col-md-12 col-lg-12 mb-3">
                <div class="card h-100">
                  <div class="card-body">
                    <h5 class="card-title">Register as business</h5>
                    <p class="card-text">
                      Some quick example text to build on the card title and make up the bulk of the card's content.
                    </p>
                    <a href="{{ route('client.registar.index') }}" :active="request()->routeIs('client.registar.indexclient.registar.index')" class="btn btn-outline-primary">Register</a>
                  </div>
                </div>
              </div></div>
              <div class="row mb-5">
